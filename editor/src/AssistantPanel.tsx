...
export function AssistantPanel({ workflowId, versionId, definition, stepTypes, disabled, onApply }: Props) {
  ...
  return <details className="assistant-panel" open>
    <summary>Editor Assistant</summary>
